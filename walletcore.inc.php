...
class WalletCoreAPI
{
	...
	/**
	 * Get Hisotry On your account list.<br />
	 * @param currency The cryptocurrency to history list.
	 */
	public function GetHistory($currency = 'ALL')
	{
		$req = array(
			'currency'      => $currency,
		);
		return $this->api_call('get_history', $req);
	}
